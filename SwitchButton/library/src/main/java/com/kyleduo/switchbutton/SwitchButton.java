...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (ta != null) {
            ...
            useAnimValue = ta.getBoolean(R.styleable.SwitchButton_kswUseAnim, useAnimValue);
            ta.recycle();
        }
    ...
    public void useAnim(boolean museAnim) {
        this.museAnim = museAnim;
    }
